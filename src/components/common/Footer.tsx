      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mt-2 max-w-xs">
              ADHD에 대한 이해와 관리를 돕는 플랫폼입니다. 자가진단, 정보 제공, 커뮤니티를 통해 함께 성장해요.
            </p>
          ...
          {/* 빠른 링크 */}
          <div>
            <FooterSectionTitle>빠른 링크</FooterSectionTitle>
            <ul className="space-y-2">
              <FooterLink to="/">홈</FooterLink>
              <FooterLink to="/about">소개</FooterLink>
              <FooterLink to="/tests/intro">ADHD 테스트</FooterLink>
              <FooterLink to="/information">정보</FooterLink>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <FooterLink to="/resources">자료실</FooterLink>
              <FooterLink to="/support">지원 센터</FooterLink>
            </ul>
          </div>
          
          {/* 법적 정보 */}
          <div>
            <FooterSectionTitle>법적 정보</FooterSectionTitle>
            <ul className="space-y-2">
              <FooterLink to="/privacy">개인정보처리방침</FooterLink>
              <FooterLink to="/terms">이용약관</FooterLink>
              <FooterLink to="/cookies">쿠키 정책</FooterLink>
            </ul>
            
            {/* 뉴스레터 구독 */}
            <div className="mt-8">
              <FooterSectionTitle>뉴스레터 구독</FooterSectionTitle>
              <div className="mt-4 flex">
                <input
                  type="email"
                  placeholder="이메일 주소"
                  className="px-4 py-2 w-full rounded-l-md bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
                <button
                  type="button"
                  className="px-4 py-2 rounded-r-md bg-purple-600 text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
                >
                  구독
                </button>
              </div>
        ...
        <div className={`py-6 border-t ${isDark ? 'border-gray-800' : 'border-gray-200'} flex flex-col md:flex-row justify-between items-center`}>
          <div className="text-sm text-gray-600 dark:text-gray-400">
            &copy; {currentYear} ADHD 플랫폼. All rights reserved.
          </div>
