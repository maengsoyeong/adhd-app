      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-12 md:pt-28">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            ...
            <span className="text-purple-600">ADHD</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-24">
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-8 rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600 text-center">검증된 테스트로 ADHD 증상을 체계적으로 평가합니다.</p>
          </div>
          ...
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-8 rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600 text-center">단 5분 만에 완료되는 간단한 자가진단 테스트입니다.</p>
          </div>
          ...
          <div className="bg-white bg-opacity-80 backdrop-blur-sm p-8 rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600 text-center">결과에 따른 맞춤형 조언과 도움이 되는 자료를 제공합니다.</p>
          </div>
        </div>
